  ...
  return (
    <Layout title="Registrar">
      <form onSubmit={handleSubmit(submitHandler)} className={classes.form}>
        <Typography component="h1" variant="h1">Registrar</Typography>
        <List>
          <ListItem>
            <Controller
              name="name"
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={errors.confirmPassword ? errors.confirmPassword.type === 'minLength' ? 'A senha precisa de no mínimo 5 caracteres' : 'Senha é necessário' : ''}
                  {...field}
                >
                </TextField>)}>
            </Controller>
          ...
          <ListItem>
            <Button variant="contained" type="submit" color="primary" fullWidth>Registrar</Button>
          </ListItem>
          <ListItem>
            Já tem uma conta? &nbsp; <NextLink href={`/login?redirect=${redirect || '/'}`} passHref><Link>Login</Link></NextLink>
          </ListItem>
        </List>
      </form>
    </Layout>
